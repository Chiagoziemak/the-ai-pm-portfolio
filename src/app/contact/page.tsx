        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="space-y-6">
              ...
              >
                <div className="w-12 h-12 rounded-xl border border-card-border bg-card/60 glass-panel flex items-center justify-center text-accent-teal group-hover:bg-accent-teal/10 transition-colors text-lg">
              ...
              <a
                ...
                className="flex items-center gap-4 group cursor-pointer"
              >
                <div className="w-12 h-12 rounded-xl border border-card-border bg-card/60 glass-panel flex items-center justify-center text-accent-teal group-hover:bg-accent-teal/10 transition-colors font-bold text-sm">
                  <span>in</span>
                </div>
                <div>
                  <p className="text-[10px] font-mono text-foreground/60 uppercase tracking-widest font-semibold">
            ...
            {/* Status Badge */}
            <div className="border border-card-border border-l-4 border-l-accent-teal bg-card/60 glass-panel p-6 rounded-2xl inline-block">
          ...
          <div className="lg:col-span-7">
            <div className="border border-card-border glass-panel bg-card/40 p-8 md:p-12 rounded-[2rem] relative overflow-hidden shadow-sm">
              ...
              {isSuccess ? (
                <div className="text-center py-16 flex flex-col items-center gap-6">
                  ...
                  <button
                    ...
                    className="mt-4 px-6 py-2 rounded-xl bg-card border border-card-border hover:bg-card-border/20 text-foreground text-sm font-semibold transition-all"
                  >
