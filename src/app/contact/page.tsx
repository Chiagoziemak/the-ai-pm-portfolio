...
import { getContactPageData, getSiteSettings } from "@/sanity/queries";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description =
    ...
    "Get in touch with Chiagoziem Melvin Akobundu for AI Product Management opportunities, consulting, teardown inquiries, and technical collaborations.";
...
export default async function ContactPage() {
  ...
  const introText =
    contactData?.introText ||
    "Whether you are looking to discuss product strategy, AI implementation, or just want to talk about technical architecture — I am always open to new connections and ambitious projects.";
  const statusMessage =
    contactData?.statusMessage || "System Status: Active & accepting inquiries";

  const email = siteSettings.contactEmail || "melvynmatthews19@gmail.com";
  const linkedin =
